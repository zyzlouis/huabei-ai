...
export default function NovelChapterList({ chapters, locale, labels }: Props) {
    ...
    <section className="mb-12">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {sorted.map((chapter, index) => (
          <Link
            key={chapter.slug}
            href={`/${locale}/stories/${chapter.slug}`}
          ...
          >
            ...
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-500">{labels.clickToRead}</span>
